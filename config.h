...
static const char *colors[][3]      = {
  ...
  [SchemeTabsSel ] = { col_gray4, col_cyan  , "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
  [SchemeTabsNorm] = { col_gray4, col_gray1 , "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
  [SchemeInfoSel ] = { col_gray4, col_gray3 , "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
